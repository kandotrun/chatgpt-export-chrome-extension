...
This repository is a privacy-sensitive Chrome extension for exporting the current ChatGPT conversation to Markdown.
...
- Use strict TDD for behavior changes:
  ...
  4. Run `npm run check`.
- For ChatGPT DOM changes, add a fixture-like snippet to `tests/extract.test.ts` before changing selectors.
